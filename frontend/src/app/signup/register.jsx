    ...
    <div className="w-full h-screen">
      ...
      <form className="grid w-full justify-center center p-10 space-y-2">
        ...
        <label className="flex items-center gap-2 px-3 py-2 border border-action-primary rounded-lg focus-within:ring-2 focus-within:ring-action-primary">
          ...
          >
            {showPassword ? (
              <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" className="fill-current w-6 h-6">
        ...
        <button className="px-6 py-2 border border-action-success text-action-success font-semibold rounded-lg hover:bg-action-success hover:text-white transition-colors disabled:opacity-50" onClick={signUp} disabled={isLoading}>
          Sign Up
        </button>
      </form>
