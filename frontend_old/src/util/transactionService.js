 ...
 */
export const createLinkToken = async (institutionId = null, institutionName = null) => {
  const payload = {};
  if (institutionId) payload.institution_id = institutionId;
  if (institutionName) payload.institution_name = institutionName;
 ...
 */
export const exchangePublicToken = async (publicToken, institutionId, institutionName) => {
